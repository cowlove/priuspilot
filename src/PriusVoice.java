...
public class PriusVoice {
	...
	public void init() {
		System.setProperty("com.sun.speech.freetts.voice.defaultAudioPlayer",
				"JavaStreamingAudioPlayerX");
		String[] args = new String[1];
		args[0] = "mbrola_us1";

		// System.out.print("VOICE SHIT\n");`
		/*
		 * List all the "general" domain voices, which are voices that are
		 * capable of attempting to speak almost any text you throw at them.
		 */
		...
		try {
			/*
			 * Find a synthesizer that has the general domain voice we are
			 * looking for. NOTE: this uses the Central class of JSAPI to find a
			 * Synthesizer. The Central class expects to find a
			 * speech.properties file in user.home or java.home/lib.
			 * 
			 * If your situation doesn't allow you to set up a speech.properties
			 * file, you can circumvent the Central class and do a very
			 * non-JSAPI thing by talking to FreeTTSEngineCentral directly. See
