...
public class Complex {
    ...
    public static Complex []complexArray(double []in) { 
    	Complex [] c = new Complex[in.length];
    	for (int i = 0; i < in.length; i++)
    		c[i] = new Complex(in[i], 0);
    	return c;
    }
	...
	public static double[] magArray(Complex[] ar) {
	...
	public static double[] arrayOfRe(Complex[] ar) {
	...
	public static double[] arrayOfIm(Complex[] ar) {
		// TODO Auto-generated method stub
		double []r = new double[ar.length];
		for (int i = 0; i < ar.length; i++) { 
			r[i] = ar[i].im;
